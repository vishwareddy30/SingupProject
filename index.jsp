...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">hi, Developers</a>
			<button
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Hi, this website is created using html, css and Javascript. 
						Thank you for visiting this website!
						If you have any questions, please don't hesitate to contact.<br>Email-iythavishwateja@gmail.com</p>
				</div>
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://github.com/vishwareddy30/Freelancertemplate"><i
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Kukatpally, Hyderabad<br />Telangana, 500072.
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
